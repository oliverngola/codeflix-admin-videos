...
describe("ListCastMembers", () => {
  ...
  it("should render error state", async () => {
    ...
    await waitFor(() => {
      const error = screen.getByText("Error Fetching CastMembers");
  ...
  it("should handle Delete CastMember success", async () => {
    renderWithProviders(<ListCastMembers />);
    ...
    await waitFor(() => {
      const name = screen.getByText("CastMember deleted successfully!");
      expect(name).toBeInTheDocument();
    });
  });
  ...
  it("should handle Delete Category error", async () => {
    ...
    await waitFor(() => {
      const name = screen.getByText("Error deleting CastMember!");
      expect(name).toBeInTheDocument();
    });
  });
});